...
This is an intermediate course in microeconomic theory and its application to real-world phenomena and policy problems. The class assumes proficiency with economic theory at the level of {{% resource_link "f0822daf-9f04-4586-8373-b9e98df8d539" "*14.01* *Principles of Microeconomics*" %}} as well as {{% resource_link "f6a3f1c9-fef0-4b39-8e7a-0a146aeba919" "multivariable calculus" %}}. It is also quite helpful if you have taken some {{% resource_link "7b87e47a-c21f-4c30-af7b-0e991ecc12ed" "linear algebra" %}}, statistics, or econometrics and are somewhat familiar with basic notions of algorithms and computing, but for those who are not familiar with these additional tools, the teaching assistants will provide a primer or fill in gaps for this material.
...
After the problem set has been graded and handed back, we are happy to go over solutions with you if they are still unclear. {{% resource_link "1277282e-f4c2-4dce-81a9-ccf0053eb3ea" "Visit the Assignments section" %}} for more information. 
